...
- Variables: Write the variables to keep from the original `.sav` database separated by a comma `,`. E.g. `P1.1,P3,P34_2.1`. Leave it empty if you want to keep all variables from the `.sav`.
